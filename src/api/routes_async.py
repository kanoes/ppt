...
from src.services.pg_metadata import get_ppt_metadata, save_ppt_metadata
...
async def generate_ppt_internal(task_id: str, query: GenerateQuery) -> str:
    ...
    if not indicator_charts_in and query.conversation:
        ...
        if charts_list:
            # Convert dictionary to IndicatorChart object
            from src.api.generate_schema import IndicatorChart
