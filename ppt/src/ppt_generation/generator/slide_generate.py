...
from ppt_generation.generator.utils import LLMInvoker, OtherUtils, PPTUtils
from ppt_generation.prompt.normal_template_prompt import (
    template1,
    template1B,
    template2,
    template3,
...
with open(RESOURCES_DIR / "title_template_info.json", "r", encoding="utf-8") as file:
    title_template_info = json.load(file)

with open(RESOURCES_DIR / "chart_template_info.json", "r", encoding="utf-8") as file:
    chart_template_info = json.load(file)

with open(RESOURCES_DIR / "reference_template_info.json", "r", encoding="utf-8") as file:
    reference_template_info = json.load(file)

with open(RESOURCES_DIR / "normal_template_info.json", "r", encoding="utf-8") as file:
