...
# テンプレート情報の読み込み
with open("./resources/test_title_template_info.json", "r") as file:
    title_template_info = json.load(file)

with open("./resources/test_chart_template_info.json", "r") as file:
    chart_template_info = json.load(file)

with open("./resources/test_reference_template_info.json", "r") as file:
    reference_template_info = json.load(file)

with open("./resources/test_normal_template_info.json", "r") as file:
...
def test_insert_content():
    presentation = Presentation("src/data/smbc_template_new.pptx")
    ...
    presentation.save("src/data/smbc_template_new.pptx")
